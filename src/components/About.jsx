...
import ABOUT  from "../constants/About.jsx"
  ...
  return (
    <section className='container mx-auto mb-8' id='about'>
        ...
        <div className="flex flex-wrap">
            <div className='w-full p-4 lg:w-1/2 rounded-bl-3xl rounded-tr-3xl'>
            ...
            <div className='w-full px-2 lg:w-1/2'>
                ...
                <motion.div 
                    ...
                    className='mb-8 mt-4  h-2 w-36 bg-rose-300 lg:-rotate-3'
                ></motion.div>
                <motion.p 
                    initial={{opacity: 0, y:50}}
                    whileInView={{opacity:1, y:0}}
