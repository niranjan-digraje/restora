...
import CUSINES from '../constants/Cusines.jsx'
...
const Experties = () => {
  return (
    <section id='expertise' >
        <h2 className='my-8 text-center text-3xl tracking-tighter lg:text-4xl '>Our Experties</h2>
        <motion.div 
            initial="hidden"
            whileInView="show"
            variants={containerVariants}
            className='containe mx-auto px-4'
        >
            {CUSINES.map((cusine,index)=>(
                ...
                >
                    <div className='flex-shrinks-0 pr-8 text-2xl'>{cusine.number}</div>
                    <div className='w-1/3 flex-shrinks-0'>
